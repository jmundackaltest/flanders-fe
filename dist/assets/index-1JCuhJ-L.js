...
function qi(e, n, t) {
  ...
  for (r in n) _c.call(n, r) && !Cc.hasOwnProperty(r) && (l[r] = n[r]);
  if (e && e.defaultProps)
...
function ua(e) {
  ...
  function S(f, a, d, v) {
    ...
    if (T.done) return t(f, C), F && gn(f, N), E;
    if (C === null) {
...
const Rd = './assets/flanders-bg-g5W1qJPi.jpg',
  Od = ({ showError: e, submitFn: n }) => {
    const t = () =>
      e &&
      U.jsx('div', {
        className: 'error-ct',
    ...
    return U.jsxs('div', {
      ...
      children: [
        U.jsx('div', {
          className: 'flanders-bg-ct',
          children: U.jsx('img', { src: Rd }),
        }),
        U.jsxs('form', {
          onSubmit: n,
          children: [
            U.jsx('div', {
              ...
              children: U.jsx('a', {
                href: 'https://www.flandersinc.com',
                children: U.jsx('img', {
            ...
            U.jsx('div', {
              ...
              children: U.jsx('input', { type: 'submit' }),
            }),
          ],
        }),
      ],
  ...
  Md = () => U.jsx('div', { className: 'home', children: 'Logged into Home' });
function jd() {
  const [e, n] = Tt.useState(!1),
    [t, r] = Tt.useState(!1),
    l = (o) => {
      o.preventDefault();
      let u = !1;
      const i = o.target,
        s = { uname: 'MAINT', pass: 'safetyiskey' };
      [...i.querySelectorAll('input.form__field')].forEach((g) => {
        const w = g.id,
          S = s[w];
        u = g.value !== S;
      });
      const h = Math.floor(Math.random() * 600 + 100),
        m = setTimeout(p, h);
      function p() {
        clearTimeout(m), n(!u), r(u);
      }
    };
  return U.jsx('div', {
    className: 'app-body',
    children: e ? U.jsx(Md, {}) : U.jsx(Od, { showError: t, submitFn: l }),
  });
}
Ql.createRoot(document.getElementById('root')).render(
  U.jsx(wc.StrictMode, { children: U.jsx(jd, {}) })
);
